...
class Category
{
     ...
     * Add nodes
     *
     * @param \Blackhouseapp\Bundle\BluehouseappBundle\Entity\Node $nodes
     * @return Post
     */
    public function addNode(\Blackhouseapp\Bundle\BluehouseappBundle\Entity\Node $nodes)
    {
        $this->nodes[] = $nodes;
     ...
     * @param \Blackhouseapp\Bundle\BluehouseappBundle\Entity\Node $nodes
     */
    public function removeNode(\Blackhouseapp\Bundle\BluehouseappBundle\Entity\Node $nodes)
    {
